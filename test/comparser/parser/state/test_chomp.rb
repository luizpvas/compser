...
class Comparser::Parser::State::TestChomp < ::Minitest::Test
  def test_chomp_single_line
    state = Comparser::Parser::State.new("abc")

    assert_equal "", state.peek_chomped
    ...
    assert_equal "a", state.peek_chomped
    ...
    assert_equal "ab", state.peek_chomped
    ...
    assert_equal "abc", state.peek_chomped
